...
void Platform::SpawnPlatform(cocos2d::Node *layer, int pos)
{
    ...
    if (isOKToAdd) {
        ...
        auto edgeBody = PhysicsBody::createEdgeBox(Size(PLATFORM_WIDTH, PLATFORM_HEIGHT + PLATFORM_HEIGHT_GAP/2), PhysicsMaterial(0,0,0), 1);
        ...
        int y = origin.y + (PLATFORM_HEIGHT  + PLATFORM_HEIGHT_GAP/2) / 2;
